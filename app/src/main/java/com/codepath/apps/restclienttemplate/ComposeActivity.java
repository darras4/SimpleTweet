        ...
        btnTweet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tweetContent.isEmpty()){
                    Toast.makeText(ComposeActivity.this, "Tweet cant be empty", Toast.LENGTH_LONG).show();
                    return;
                }
                if (tweetContent.length() > MAX_TWEET_LENGTH){
                    Toast.makeText(ComposeActivity.this, "Tweet cant be big", Toast.LENGTH_LONG).show();
                    return;
                }
